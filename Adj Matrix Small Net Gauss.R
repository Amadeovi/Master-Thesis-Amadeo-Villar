...
# We fist start with a strongly chordal graph 
...
# families:
family12 <- rep(c(rep(1,10)),each=6)
family23 <- rep(c(rep(1,10)),each=6)
family34 <- rep(c(rep(1,10)),each=6) 
family13.2 <- rep(c(rep(1,10)),each=6)   
family24.3 <- rep(c(rep(1,10)),each=6) 
...
write.csv(A,"C:/Users/amade/OneDrive/Escritorio/Master Thesis Applied Maths/data files//A glasso small network gauss.csv", row.names = FALSE)
write.csv(B,"C:/Users/amade/OneDrive/Escritorio/Master Thesis Applied Maths/data files//B pc small network gauss.csv", row.names = FALSE)
write.csv(C,"C:/Users/amade/OneDrive/Escritorio/Master Thesis Applied Maths/data files//C hc small network gauss.csv", row.names = FALSE)

A.smallnetworkgauss=A
B.smallnetworkgauss=B
C.smallnetworkgauss=C
